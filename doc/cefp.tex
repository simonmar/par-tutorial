...
\author{Simon Marlow\\\texttt{simonamr@microsoft.com}\\Microsoft Research Ltd., Cambridge, U.K.}
...
\url{http://community.haskell.org/~simonmar/par-tutorial/par-tutorial-\version.tar.gz}.
